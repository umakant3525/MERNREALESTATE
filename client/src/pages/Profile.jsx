  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <p className=" text-green-700 text-center mt-5 ">
       ...
       <button onClick={handleShowListings} className=' text-green-700 text-center  hover:opacity-80 w-full '> Show Listings </button>
      <p className=" text-red-700 text-center mt-3 w-full ">{showListingsError ? "There is error in showing listing " : ""}</p>
